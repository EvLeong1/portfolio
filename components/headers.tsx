...
export default function Header() {
    ...
    border border-white border-opacity-40 bg-gray-100 bg-opacity-80
    shadow-lg shadow-black/[0.05] backdrop:blur-[0.5rem]
    sm:top-6 sm:h-[3.25rem] sm:w-[44rem] sm:rounded-full" //changed sm:w to 44rem instead of default to add Education Tab

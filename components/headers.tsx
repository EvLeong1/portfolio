...
export default function Header() {
    ...
    py-2 sm:top-[1.7rem] sm:h-[initial] sm:py-0 mt-4">
        <ul className="flex w-[22rem] flex-wrap items-center justify-center gap-y-1 text-[0.9rem] font-bold text-gray-700 dark:text-gray-300
        sm:w-[initial] sm:flex-nowrap sm:gap-5">
            {
                links.map(link => (
                    ...
                    >
                        <Link className = {
                            clsx("flex w-full items-center justify-center px-3 py-3 hover:text-gray-950 dark:hover:text-gray-400 transition",
                            {
                        ...
                        >
                                {link.name}
                            {
                                link.name === activeSection && (<motion.span 
                                                        className='bg-[#ADA393] dark:bg-gray-600 rounded-full absolute inset-0 -z-10'
